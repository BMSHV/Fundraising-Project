...
public class UserEntity {
	...
	//@ApiModelProperty(notes = "categoryname of the user",name="usercategoryname",required=true)
	@Column(name="categoryname")
	private String categoryName;
	
	//@ApiModelProperty(notes = "description of the user",name="userdescription",required=true)
	@Column(name="description")
	private String userDescription;
	
	//@ApiModelProperty(notes = "fundamount of the user",name="userfundamount",required=true)
	@Column(name="fundamount")
	private float userFundAmount;
	
	//@ApiModelProperty(notes = "account of the user",name="useraccountnumber",required=true)
	@Column(name="account")
